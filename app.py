...
SYSTEM_PROMPT = """You are IoT Assistant AI.
Only answer questions related to: Internet of Things, sensors, NodeMCU, ESP32, Arduino, actuators, circuits, Blynk, MQTT, and IoT projects.
...
@app.route("/")
def home():
    return render_template("index.html", bot_name="IoT Assistant AI")
